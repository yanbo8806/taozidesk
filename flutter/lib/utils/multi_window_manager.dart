...
class taoziappMultiWindowManager {
  taoziappMultiWindowManager._();

  static final instance = taoziappMultiWindowManager._();
  ...
  /// `taoziappWinManager.call(WindowType.Main, kWindowEventHide, {"id": windowId!});`
...
final taoziappWinManager = taoziappMultiWindowManager.instance;
