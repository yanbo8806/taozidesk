...
class FfiModel with ChangeNotifier {
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionstaoziappVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionstaoziappVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionstaoziappVirtualDisplays);
        }
  ...
  void setViewOnly(String id, bool value) {
    ...
    // tmp fix for https://github.com/taoziapp/taoziapp/pull/3706#issuecomment-1481242389
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get taoziappVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionstaoziappVirtualDisplays] ?? []);
  ...
  bool get istaoziappIdd =>
      platformAdditions[kPlatformAdditionsIddImpl] == 'taoziapp_idd';
