...
class _DesktopTabState extends State<DesktopTab>
  ...
  void onWindowClose() async {
    ...
    if (isMainWindow) {
      if (taoziappWinManager.getActiveWindows().contains(kMainWindowId)) {
        await taoziappWinManager.unregisterActiveWindow(kMainWindowId);
      }
