...
#
# Script to build F-Droid release of taoziapp
#
# Copyright (C) 2024, The taoziapp Authors
...
#
# - versionName from https://github.com/taoziapp/taoziapp/releases/download/fdroid-version/taoziapp-version.txt
# - versionCode from https://github.com/taoziapp/taoziapp/releases/download/fdroid-version/taoziapp-version.txt
...
arm64-v8a)
	...
	taoziapp_FEATURES='flutter,hwcodec'
	;;
armeabi-v7a)
...
prebuild)
	...
	# Flutter used to compile main taoziapp library
	...
	# Install Flutter version for taoziapp library build
...
build)
	...
	cargo ndk \
		...
		build \
		--release \
		--features "${taoziapp_FEATURES}"

	mkdir -p "flutter/android/app/src/main/jniLibs/${ANDROID_ABI}"

	cp "target/${RUST_TARGET}/release/liblibtaoziapp.so" \
		"flutter/android/app/src/main/jniLibs/${ANDROID_ABI}/libtaoziapp.so"
