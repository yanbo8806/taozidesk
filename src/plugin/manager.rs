...
fn get_plugin_source_list() -> Vec<PluginSource> {
    ...
    // vec![PluginSource {
    //     name: "taoziapp".to_string(),
    //     url: "https://raw.githubusercontent.com/fufesou/taoziapp-plugins/main".to_string(),
...
fn elevate_install(
    ...
    crate::platform::elevate(args, "taoziapp wants to install then plugin")
}
...
fn elevate_uninstall(plugin_id: &str) -> ResultType<bool> {
    crate::platform::elevate(
        ...
        "taoziapp wants to uninstall the plugin",
    )
}
