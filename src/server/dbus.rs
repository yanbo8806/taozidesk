...
///
/// Note:
/// On linux, we use dbus to communicate multiple taoziapp process.
...
const DBUS_NAME: &str = "org.taoziapp.taoziapp";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "taoziapp DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.taoziapp.taoziapp /dbus org.taoziapp.taoziapp.NewConnection string:'PEER_ID'`
