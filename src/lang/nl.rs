...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Klaar"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het taoziapp netwerk..."),
        ...
        ("install_tip", "Door UAC-beperkingen lukt het niet altijd om uw bureaublad op afstand te bedienen. Installeer taoziapp op het systeem om dit probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u taoziapp toestemming voor Toegankelijkheid geven."),
        ("config_screen", "Om uw apparaat op afstand te kunnen bedienen, moet u taoziapp toestemming voor Schermopname geven."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u taoziapp toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [taoziapp Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep taoziapp background service", "taoziapp achtergronddienst behouden"),
        ...
        ("config_input", "Om een extern apparaat met uw toetsenbord te kunnen bedienen, moet u taoziapp toestemming voor Invoer Vastleggen geven."),
        ("config_microphone", "Om te kunnen chatten moet u taoziapp toestemming voor Microfoon geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende taoziapp."),
        ...
        ("verify_taoziapp_password_tip", "Bevestiging wachtwoord taoziapp"),
        ...
        ("scam_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om taoziapp te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ...
        ("upgrade_taoziapp_server_pro_to_{}_tip", "Upgrade taoziapp Server Pro naar versie {} of nieuwer!"),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor taoziapp mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("powered_by_me", "Werkt met taoziapp"),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het taoziapp-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt taoziapp op de achtergrond actief te houden"),
        ...
        ("upgrade_remote_taoziapp_client_to_{}_tip", "Upgrade de taoziapp client naar versie {} of nieuwer op de externe computer!"),
