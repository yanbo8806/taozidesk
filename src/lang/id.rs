...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke taoziapp..."),
        ...
        ("install_tip", "Karena UAC, taoziapp tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal taoziapp ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk taoziapp."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk taoziapp."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android Anda melalui mouse atau sentuhan, Anda harus mengizinkan taoziapp untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input taoziapp]."),
        ...
        ("Language", "Bahasa"),
        ("Keep taoziapp background service", "Pertahankan taoziapp berjalan pada service background"),
        ...
        ("Show taoziapp", "Tampilkan taoziapp"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada taoziapp"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada taoziapp"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC taoziapp yang sedang berjalan"),
        ...
        ("verify_taoziapp_password_tip", "Verifikasi Kata Sandi taoziapp"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan taoziapp, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_taoziapp_server_pro_to_{}_tip", "Silahkan perbarui taoziapp Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah taoziapp berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh taoziapp"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela taoziapp sedang terbuka."),
        ...
        ("Floating window", ""),
        ("floating_window_tip", "Untuk menjaga layanan/service taoziapp agar tetap aktif"),
        ...
        ("About taoziapp", "Tentang taoziapp"),
        ...
        ("upgrade_remote_taoziapp_client_to_{}_tip", "Silahkan perbarui aplikasi taoziapp ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
