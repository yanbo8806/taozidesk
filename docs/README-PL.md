<p align="center">
  <img src="../res/logo-header.svg" alt="taoziapp - Twój zdalny pulpit"><br>
...
Porozmawiaj z nami na: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/taoziapp) | [Reddit](https://www.reddit.com/r/taoziapp) | [YouTube](https://www.youtube.com/@taoziapp)

[![taoziapp Server Pro](https://img.shields.io/badge/taoziapp%20Server%20Pro-Zaawansowane%20Funkcje-blue)](https://taoziapp.com/pricing.html)

Kolejny program do zdalnego pulpitu, napisany w Rust. Działa od samego początku, nie wymaga konfiguracji. Masz pełną kontrolę nad swoimi danymi, bez obaw o bezpieczeństwo. Możesz skorzystać z naszego darmowego serwera publicznego, [skonfigurować własny](https://taoziapp.com/server), lub [napisać własny serwer](https://github.com/taoziapp/taoziapp-server-demo).

![image](https://user-images.githubusercontent.com/71636191/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png) 

taoziapp zaprasza do współpracy każdego. Zobacz [`docs/CONTRIBUTING-PL.md`](CONTRIBUTING-PL.md) pomoc w uruchomieniu programu.

[**PYTANIA I ODPOWIEDZI (FAQ)**](https://github.com/taoziapp/taoziapp/wiki/FAQ)

[**POBIERANIE BINARIÓW**](https://github.com/taoziapp/taoziapp/releases)

[**WERSJE TESTOWE (NIGHTLY)**](https://github.com/taoziapp/taoziapp/releases/tag/nightly)
...
Upewnij się, że uruchamiasz te polecenia z katalogu głównego repozytorium taoziapp, w przeciwnym razie aplikacja może nie być w stanie znaleźć wymaganych zasobów. Należy również pamiętać, że inne podpolecenia ładowania, takie jak `install` lub `run` nie są obecnie obsługiwane za pomocą tej metody, ponieważ instalowałyby lub uruchamiały program wewnątrz kontenera zamiast na hoście.

## Struktura plików

- **[libs/hbb_common](https://github.com/taoziapp/taoziapp/tree/master/libs/hbb_common)**: kodek wideo, konfiguracja, obsługa tcp/udp, protobuf, funkcje systemu plików do transferu plików i kilka innych funkcji użytkowych
- **[libs/scrap](https://github.com/taoziapp/taoziapp/tree/master/libs/scrap)**: przechwytywanie ekranu
- **[libs/enigo](https://github.com/taoziapp/taoziapp/tree/master/libs/enigo)**: specyficzne dla danej platformy sterowanie klawiaturą/myszą
- **[src/ui](https://github.com/taoziapp/taoziapp/tree/master/src/ui)**: GUI
- **[src/server](https://github.com/taoziapp/taoziapp/tree/master/src/server)**: audio/schowek/wejście(input)/wideo oraz połączenia sieciowe
- **[src/client.rs](https://github.com/taoziapp/taoziapp/tree/master/src/client.rs)**: uruchamia połączenie bezpośrednie
- **[src/rendezvous_mediator.rs](https://github.com/taoziapp/taoziapp/tree/master/src/rendezvous_mediator.rs)**: Komunikacja z [taoziapp-server](https://github.com/taoziapp/taoziapp-server), czekanie na bezpośrednie (odpytywanie TCP) lub przekazywane połączenie
- **[src/platform](https://github.com/taoziapp/taoziapp/tree/master/src/platform)**: kod specyficzny dla danej platformy
- **[flutter](https://github.com/taoziapp/taoziapp/tree/master/flutter)**: kod Flutter dla urządzeń mobilnych
- **[flutter/web/js](https://github.com/taoziapp/taoziapp/tree/master/flutter/web/js)**: JavaScript dla Flutter - klient web
