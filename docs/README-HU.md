<p align="center">
  ...
  <b>Kell a segítséged, hogy lefordítsuk ezt a README-t, <a href="https://github.com/taoziapp/taoziapp/tree/master/src/lang">a taoziapp UI-t</a> és a <a href="https://github.com/taoziapp/doc.taoziapp.com">Dokumentációt</a> az anyanyelvedre</b>
</p>

Beszélgess velünk: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/taoziapp) | [Reddit](https://www.reddit.com/r/taoziapp) | [YouTube](https://www.youtube.com/@taoziapp)

[![taoziapp Server Pro](https://img.shields.io/badge/taoziapp%20Server%20Pro-Speci%C3%A1lis%20Funkci%C3%B3k-blue)](https://taoziapp.com/pricing.html)

A taoziapp egy távoli elérésű asztali szoftver, Rust-ban írva. Működik mindenféle konfiguráció nélkül, feltelepítéssel, vagy anélkül. Az adataidat teljesen te kezeled, nincs szükség aggódásra a harmadik felek miatt. Használhatod a taoziapp punblikus randevú/relay szervereit, [hostolhatsz sajátot](https://taoziapp.com/server), vagy akár [írhatsz is egyet](https://github.com/taoziapp/taoziapp-server-demo).

![image](https://user-images.githubusercontent.com/71636191/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png)

A taoziapp szívesen fogad minden contributiont, támogatást mindenkitől. Lásd a [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) fájlt a kezdéshez.

[**Hogyan működik a taoziapp?**](https://github.com/taoziapp/taoziapp/wiki/How-does-taoziapp-work%3F)

[**BINARY LELTÖLTÉS**](https://github.com/taoziapp/taoziapp/releases)
...
## [Építés](https://taoziapp.com/docs/hu/dev/build/)
...
Ezután, minden egyes alkalommal amikor meg kell építened a taoziapp-et, futtasd a kövezkező parancsot:
...
Kérlek mindenképpen nézd meg hogy ezeket a parancsokat a root taoziapp mappában futtatod e, különben a taoziapp lehet hogy nem fogja megtalálni az építéshez szükséges elemeket. Fontos az is, hogy jelenleg más cargo subparancsok, például `install`vagy `run` nem támogatottak, mivel egy Dockeres építés esetén elindítanák a programot a containeren belül.
