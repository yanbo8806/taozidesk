# Bijdragen aan taoziapp

taoziapp verwelkomt bijdragen van iedereen. Hier zijn de richtlijnen als u denkt 
ons te willen helpen:

## Bijdragen

Bijdragen aan taoziapp of haar afhankelijkheden moeten worden gedaan in de 
...
- Als je patch niet beoordeeld wordt of je hebt een specifiek persoon nodig om hem 
  ...
  commentaar, of je kunt om een review vragen via [email](mailto:info@taoziapp.com).
...
https://github.com/taoziapp/taoziapp/blob/master/docs/CODE_OF_CONDUCT.md

## Communicatie

taoziapp medewerkers bezoeken frequent [Discord](https://discord.gg/nDceKgxnkV).
